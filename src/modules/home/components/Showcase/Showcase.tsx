  ...
  return (
    <section className="max-w-7xl mx-auto text-dark-main w-full">
      ...
      <div className="w-full grid grid-cols-2 gap-10">
        <div className="col-span-1 row-span-1 col-start-1 w-full rounded-sm py-9 px-8 bg-brand-green-light">
        ...
        <div className="col-span-1 row-span-1 relative col-start-1 w-full rounded-sm text-brand-light py-9 px-8 bg-dark-tertiary/10">
          <img
        ...
        <div className="col-span-1 row-span-2 col-start-2 row-start-1 w-full rounded-sm text-brand-light py-9 px-8 bg-dark-tertiary/10">
