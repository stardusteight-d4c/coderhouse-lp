...
import { cn } from "@/shared/libs/clsx"
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ArrowLeftIcon className="h-4 w-4 !text-dark-main !brightness-100 !opacity-100" />
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ArrowRightIcon className="h-4 w-4 !text-dark-main !brightness-100 !opacity-100" />
